...
template <> constexpr inline auto Project::qt_create_metaobjectdata<qt_meta_tag_ZN7ProjectE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(Layer *)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Signal 'layersChanged'
        QtMocHelpers::SignalData<void()>(8, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'onionSkinSettingsChanged'
...
void Project::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->currentFrameChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->currentLayerChanged((*reinterpret_cast<std::add_pointer_t<Layer*>>(_a[1]))); break;
        case 3: _t->layersChanged(); break;
        case 4: _t->onionSkinSettingsChanged(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Project::*)()>(_a, &Project::modified, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Project::*)(int )>(_a, &Project::currentFrameChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Project::*)(Layer * )>(_a, &Project::currentLayerChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Project::*)()>(_a, &Project::layersChanged, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (Project::*)()>(_a, &Project::onionSkinSettingsChanged, 4))
            return;
    }
}
...
// SIGNAL 1
void Project::currentFrameChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void Project::currentLayerChanged(Layer * _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void Project::layersChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void Project::onionSkinSettingsChanged()
{
