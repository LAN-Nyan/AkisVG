...
template <> constexpr inline auto Layer::qt_create_metaobjectdata<qt_meta_tag_ZN5LayerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'typeChanged'
        QtMocHelpers::SignalData<void(LayerType)>(7, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 8, 9 },
        }}),
    };
...
void Layer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->lockedChanged((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
        case 3: _t->typeChanged((*reinterpret_cast<std::add_pointer_t<LayerType>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Layer::*)()>(_a, &Layer::modified, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Layer::*)(bool )>(_a, &Layer::visibilityChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Layer::*)(bool )>(_a, &Layer::lockedChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Layer::*)(LayerType )>(_a, &Layer::typeChanged, 3))
            return;
    }
}
...
// SIGNAL 2
void Layer::lockedChanged(bool _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1);
}

// SIGNAL 3
void Layer::typeChanged(LayerType _t1)
{
